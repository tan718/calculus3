...
\begin{example}
  ...
  \begin{explanation}
    ...
    \begin{align*}
      \int_{\answer[given]{0}}^{\answer[given]{4}} \int_{\answer[given]{0}}^{\answer[given]{-3x+4}} \int_{\answer[given]{0}}^{\answer[given]{\frac{12-3x-4y}{6}}}\d z \d y\d x &=\int_{\answer[given]{0}}^{\answer[given]{4}} \int_{\answer[given]{0}}^{\answer[given]{-3x+4}} \answer[given]{\frac{12-3x-4y}{6}} \d y \d x\\
      &= \int_{\answer[given]{0}}^{\answer[given]{4}}  \eval{\answer[given]{\frac{12-3x-2y^2}{6}}}_{\answer[given]{0}}^{\answer[given]{-3x+4}} \d x\\
      &= \int_{\answer[given]{0}}^{\answer[given]{4}}  \left(\answer[given]{\frac{12-3x-2(-3x+4)^2}{6} - \frac{12-3x}{6}}\right) \d x\\
      &= \eval{\answer[given]{3x-3x^2/4+x^3/16}}_{\answer[given]{0}}^{\answer[given]{4}} \d x\\
      &=\answer[given]{4}.
    \end{align*}    
  \end{explanation}
\end{example}
...
\begin{question}
  ...
  \begin{prompt}
    \[
    \int_R \d A = \int_{\answer{0}}^{\answer{3}}\int_{\answer{0}}^{\answer{-2y/3+2}} \int_{\answer{0}}^{\answer{\frac{12-4y-6z}{3}}} \d x \d z \d y
    \]
  \end{prompt}
\end{question}
...
\begin{question}
  ...
  \begin{prompt}
    \[
    \int_R \d A = \int_{\answer{0}}^{\answer{2}}\int_{\answer{-z}}^{\answer{z}} \int_{\answer{-\sqrt{z^2-y^2}}}^{\answer{\sqrt{z^2-y^2}}} \d x \d y \d z
    \]
  \end{prompt}
\end{question}
