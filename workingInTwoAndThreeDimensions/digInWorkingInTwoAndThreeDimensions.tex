...
\begin{question}
  What is the distance between the points $P=(-17,379)$ and $Q=(14,-101)$?
  \begin{prompt}
    \[
    ...
    \begin{image}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[color=penColor2,fill=penColor2,only marks,mark=*] coordinates{(1.4,2.7)};  %% closed hole
          \addplot[color=penColor,fill=penColor,only marks,mark=*] coordinates{(2.6,2.9)};  %% closed hole
