...
\begin{image}
  \begin{tikzpicture}
    ...
    \node[below,inner sep=0pt,text width=4cm,scale=.5] at (1.65,-1) {we can compute the difference in the values of $f$ when evaluated on the boundry.};
  \end{tikzpicture}
\end{image}
...
\begin{image}
  \begin{tikzpicture}
    ...
    \node[below,inner sep=0pt,text width=4cm,scale=.5] at (1.5,-1) {we can compute the difference in the values of $F$ when evaluated on the boundry.};
  \end{tikzpicture}
\end{image}
...
\begin{image}
  \begin{tikzpicture}
    \node[inner sep=0pt] at (0,0) {$\iint_R \curl\vec{F}\d A\quad =\quad \int_C \vec{F}\dotp\d\vec{p}$};
    ...
    \node[below,inner sep=0pt,text width=4cm,scale=.5] at (1.8,-1) {we can compute the accumulation of $\vec{F}$ along a boundry curve $C$.};
  \end{tikzpicture}
\end{image}
