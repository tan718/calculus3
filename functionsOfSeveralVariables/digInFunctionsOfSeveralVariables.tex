    ...
    \begin{image}
      \begin{tikzpicture}[>=stealth]
	    ...
	    zlabel={\scriptsize $z$},
          ...
          \addplot3[domain=-6.5:6.5,y domain=-6.5:6.5,mesh,samples y=40,very thin,z buffer=sort,
          ...
          \addplot3 [very thick,penColor, smooth,domain=0:360,samples=60,samples y=0] ({-1.25 + 1.45774*cos(x)}, {-1.25 + 1.45774*sin(x)},-.4);
          \addplot3 [very thick,penColor, smooth,domain=0:360,samples=60,samples y=0] ({-2.5 + 3.39116*cos(x)},{-2.5 + 3.39116*sin(x)},-.2);
          \addplot3 [very thick,penColor, smooth,domain=-5:5,samples=60] (x,-x,0);
          \addplot3 [very thick,penColor, smooth,domain=0:360,samples=60,samples y=0] ({2.5 + 3.39116*cos(x)}, {2.5 + 3.39116*sin(x)},.2);
          \addplot3 [very thick,penColor, smooth,domain=0:360,samples=60,samples y=0] ({1.25 + 1.45774*cos(x)},{1.25 + 1.45774*sin(x)},.4);
          \addplot3 [very thick,penColor, smooth,domain=0:360,samples=60,samples y=0] ({0.833333 + 0.62361*cos(x)},{0.833333 + 0.62361*sin(x)},.6);
          %\filldraw [penColor] (axis cs: 0,0,1) circle (1pt);
