...
variables. We will now define a function of several variables:
...
\begin{example}
  ...
  \begin{explanation}
    ...
    \end{align*}
    Now we just need to plot for $c=0$, $0.2$, $0.4$, $0.6$, $0.8$ and
    $1$
    \begin{align*}
    ...
    \begin{onlineOnly}
      ...
      level curves:
      \[
      \graph[xmin=-5, xmax=5, ymin=-2.3, ymax=2.3]{1-0^2= \frac{x^2}{9}+\frac{y^2}{4}, 1 - 0.2^2 = \frac{x^2}{9}+\frac{y^2}{4},1 - 0.4^2 = \frac{x^2}{9}+\frac{y^2}{4},1 - 0.6^2 = \frac{x^2}{9}+\frac{y^2}{4},1 - 0.8^2 = \frac{x^2}{9}+\frac{y^2}{4},1 - 0 = \frac{x^2}{9}+\frac{y^2}{4}}
      \]
    \end{onlineOnly}
    \begin{image}
      \begin{tikzpicture}
	    ...
	    zlabel={\scriptsize $z$},colormap/cool
          ...
          \addplot3 [very thick,penColor, smooth,domain=-30:170,samples=60,samples y=0] ({3*(cos(x))},{2*(sin(x))},0);
          
          \addplot3 [very thick,penColor, smooth,domain=-30:170,samples=60,samples y=0] ({2.93*(cos(x))},{1.96*(sin(x))},.2);
          
          \addplot3 [very thick,penColor, smooth,domain=-30:170,samples=60,samples y=0] ({2.75*(cos(x))},{1.83*(sin(x))},.4);
          
          \addplot3 [very thick,penColor, smooth,domain=-35:170,samples=60,samples y=0] ({2.4*(cos(x))},{1.6*(sin(x))},.6);
      ...
      \end{tikzpicture}
    \end{image}
      In the image above, the level curves are drawn on a graph of $F$
      in space. Note how the elevations are evenly spaced. Near the
...
\begin{example}
  ...
  \begin{explanation}
    ...
    \begin{onlineOnly}
      ...
      level curves:
      \[
      \graph{x+y = 0.6(x^2+y^2+1),x+y = 0.4(x^2+y^2+1), x+y = 0.2(x^2+y^2+1),x+y = 0,x+y = -0.2(x^2+y^2+1),x+y = -0.4(x^2+y^2+1),x+y = -0.6(x^2+y^2+1)}
      \]
    \end{onlineOnly}
    \begin{image}
      \begin{tikzpicture}[>=stealth]
	    ...
	    zlabel={\scriptsize $z$},
          ...
          \addplot3[domain=-5:5,y domain=-5:5,mesh,samples y=30,very thin,z buffer=sort,
